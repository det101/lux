 ...
 */	
	public class LoaderItem extends LoaderCore {
		...
		public static var fileObject:Object
		...
		public function LoaderItem(urlOrRequest:*, vars:Object=null) {
			...
			var _testUrl:String=getAllName(_request.url);
			if(fileObject && fileObject[_testUrl]){
				_request.url=fileObject[_testUrl];
				trace("url改了....:"+fileObject[_testUrl]);
			}
			_url = _request.url;
		}
		
		protected function getAllName(rawAsset:Object):String
		{
			var matches:Array;
			var name:String;
